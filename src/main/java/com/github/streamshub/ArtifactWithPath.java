...
public class ArtifactWithPath {
     ...
     */
    public ArtifactWithPath(Artifact artifact) {
        this.artifact = artifact;
        this.dependencyPath = List.of(artifact);
        this.isDirect = true;
    }
     ...
     */
    public ArtifactWithPath(Artifact artifact, List<Artifact> dependencyPath) {
        this.artifact = artifact;
        this.dependencyPath = List.copyOf(dependencyPath);
        this.isDirect = dependencyPath.size() == 1;
    }
    ...
    public String formatDependencyPath() {
        ...
        for (int i = dependencyPath.size() - 2; i >= 0; i--) {
            sb.append(" <- ");
            sb.append(dependencyPath.get(i).toString());
        }
