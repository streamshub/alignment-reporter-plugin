...
public final class ShadeAnalyzer {
    ...
    public static final class ShadeConfiguration {
        ...
        public ShadeConfiguration(final List<ShadeRelocation> relocations,
    ...
    public List<ShadeConfiguration> analyzeAllShadeConfigurations(final List<MavenProject> projects) {
    ...
    public boolean isArtifactShaded(final String groupId, final String artifactId, final List<ShadeConfiguration> shadeConfigs) {
    ...
    private List<ShadeRelocation> parseRelocations(final Xpp3Dom configuration) {
        List<ShadeRelocation> relocations = new ArrayList<>();
